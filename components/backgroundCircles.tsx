...
const BackgroundCircles = () => {
    return (
        <motion.div
            ...
            className='relative flex justify-center top-40 items-center'
        >
            ...
            <div className='absolute border border-[#f7ab0a] rounded-full opacity-20 h-[650px] w-[650px] animate-pulse' />
        </motion.div>
    )
}
